...
| Metadata-only | 98.1% |
| Rows / document | 0.93 |
| Potential rows / document | 6.48 |
| DOI → full text | 0.0% |
| Mean usable words | 97 |
...
| Metadata % | 60.87 |
| Full-text % | 8.7 |
| DOI full-text rate | 42.11 |
| Avg content size (chars) | 3600.2 |
| Avg richness | 55.92 |
...
|-------|-------------------:|
| Content-size uplift proxy | ~2.91 |
| Full-text mix proxy (70% of potential on FT docs) | ~1.24 |
