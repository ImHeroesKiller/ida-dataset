...
?? automation/learning/state/sessions/SES-20260727-F1813A.jsonl
?? automation/learning/state/snapshot_2026-07-27.json
?? automation/sessions/2026-07-27/
?? reports/production/production_trace_SES-20260727-F1813A.json
?? reports/production/sessions/SES-20260727-F1813A/
```
...
```
 ...
 reports/reliability/worktree_before_sync.md        | 140 +++----
 reports/reliability/writer_finalize.json           |   4 +-
 85 files changed, 1704 insertions(+), 1105 deletions(-)
```
