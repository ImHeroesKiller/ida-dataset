...
?? automation/learning/state/sessions/SES-20260724-887505.jsonl
?? automation/learning/state/snapshot_2026-07-24.json
?? automation/sessions/2026-07-24/
?? reports/production/production_trace_SES-20260724-887505.json
?? reports/production/sessions/SES-20260724-887505/
```
...
```
 ...
 reports/reliability/worktree_before_sync.md        |  214 +++--
 reports/reliability/writer_finalize.json           |    4 +-
 89 files changed, 2891 insertions(+), 1350 deletions(-)
```
