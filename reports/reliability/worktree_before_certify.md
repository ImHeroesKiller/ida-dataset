...
?? automation/learning/state/sessions/SES-20260806-C741AA.jsonl
?? automation/learning/state/snapshot_2026-08-06.json
?? automation/sessions/2026-08-06/
?? reports/production/production_trace_SES-20260806-C741AA.json
?? reports/production/sessions/SES-20260806-C741AA/
```
...
```
 ...
 reports/reliability/git_worktree_trace.md          | 293 ++++++++++++++++
 reports/reliability/worktree_before_sync.md        | 146 ++++----
 reports/reliability/writer_finalize.json           |   4 +-
 82 files changed, 1623 insertions(+), 1042 deletions(-)
```
