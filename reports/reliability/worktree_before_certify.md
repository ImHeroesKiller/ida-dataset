...
?? automation/learning/state/sessions/SES-20260812-1C724F.jsonl
?? automation/learning/state/snapshot_2026-08-12.json
?? automation/sessions/2026-08-12/
?? reports/production/production_trace_SES-20260812-1C724F.json
?? reports/production/sessions/SES-20260812-1C724F/
```
...
```
 ...
 automation/learning/state/production_trace.json    | 386 ++++++++++-----------
 ...
 reports/reliability/git_worktree_trace.md          | 299 ++++++++++++++++
 reports/reliability/worktree_before_sync.md        |  82 ++---
 reports/reliability/writer_finalize.json           |   4 +-
 84 files changed, 1687 insertions(+), 1068 deletions(-)
```
