...
?? automation/learning/state/sessions/SES-20260728-4E31D4.jsonl
?? automation/learning/state/snapshot_2026-07-28.json
?? automation/sessions/2026-07-28/
?? reports/production/production_trace_SES-20260728-4E31D4.json
?? reports/production/sessions/SES-20260728-4E31D4/
```
...
```
 ...
 reports/reliability/worktree_before_sync.md        | 142 +++----
 reports/reliability/writer_finalize.json           |   4 +-
 85 files changed, 1685 insertions(+), 1087 deletions(-)
```
