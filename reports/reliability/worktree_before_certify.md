...
?? automation/learning/state/sessions/SES-20260717-22651F.jsonl
?? automation/learning/state/snapshot_2026-07-17.json
?? automation/sessions/2026-07-17/
?? reports/production/production_trace_SES-20260717-22651F.json
?? reports/production/sessions/SES-20260717-22651F/
```
...
```
 ...
 automation/learning/state/discovery_analytics.json |  348 +++++--
 ...
 automation/learning/state/production_trace.json    | 1094 +++++++++++++-------
 ...
 reports/diagnostics/document_trace.md              |   56 +-
 ...
 reports/production/document_pipeline.md            |   56 +-
 ...
 reports/reliability/git_worktree_trace.md          |  314 ++++++
 reports/reliability/worktree_before_sync.md        |   96 +-
 reports/reliability/writer_finalize.json           |    4 +-
 89 files changed, 2807 insertions(+), 1463 deletions(-)
```
