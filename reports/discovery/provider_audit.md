...
|----------|--------|---------|------------|----------:|------------:|--------|-----------:|---------:|---------:|------:|--------|
| Tavily (primary) | **ACTIVE** | True | True | 20 | 1000 | ACTIVE | 2213.9 | 144.0 | 120.0 | 1.0 | ready |
...
| Common Crawl Index | **ACTIVE** | True | True | 5 | 500 | healthy | 0.0 | 75.0 | 40.0 | 1.0 | ready |
...
- Probe: `{"probed": true, "ok": true, "status": "ACTIVE", "message": "http_200_results_0", "latency_ms": 2213.9, "http_status": 200, "result_count": 0}`
