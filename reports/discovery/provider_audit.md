...
|----------|--------|---------|------------|----------:|------------:|--------|-----------:|---------:|---------:|------:|--------|
| Tavily (primary) | **ACTIVE** | True | True | 20 | 1000 | ERROR | 130.2 | 0.0 | 0.0 | 1.0 | ready |
...
| Google Programmable Search | **DISABLED** | False | False | 10 | 100 | offline | 0.01 | 0.0 | 0.0 | 1.0 | enabled=false in discovery_registry.yaml |
...
- Probe: `{"probed": true, "ok": false, "status": "ERROR", "message": "connectivity_failed:HTTPError", "latency_ms": 130.2}`
