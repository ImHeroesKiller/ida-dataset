...
|----------|--------|---------|------------|----------:|------------:|--------|-----------:|---------:|---------:|------:|--------|
| Tavily (primary) | **ACTIVE** | True | True | 20 | 1000 | ACTIVE | 1048.0 | 94.0 | 89.0 | 1.0 | ready |
...
| Common Crawl Index | **ACTIVE** | True | True | 5 | 500 | healthy | 0.0 | 30.0 | 10.0 | 1.0 | ready |
...
- Probe: `{"probed": true, "ok": true, "status": "ACTIVE", "message": "http_200_results_1", "latency_ms": 1048.0, "http_status": 200, "result_count": 1}`
