...
|----------|--------|---------|------------|----------:|------------:|--------|-----------:|---------:|---------:|------:|--------|
| Tavily (primary) | **ACTIVE** | True | True | 20 | 1000 | ACTIVE | 1131.8 | 160.0 | 137.0 | 1.0 | ready |
...
| RSS Discovery | **ACTIVE** | True | True | 30 | 10000 | healthy | 0.0 | 12.0 | 12.0 | 1.0 | ready |
| Atom Discovery | **ACTIVE** | True | True | 30 | 10000 | healthy | 0.0 | 0.0 | 0.0 | 1.0 | ready |
| Common Crawl Index | **ACTIVE** | True | True | 5 | 500 | healthy | 0.0 | 40.0 | 10.0 | 1.0 | ready |
...
- Probe: `{"probed": true, "ok": true, "status": "ACTIVE", "message": "http_200_results_1", "latency_ms": 1131.8, "http_status": 200, "result_count": 1}`
