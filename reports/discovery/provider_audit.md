...
|----------|--------|---------|------------|----------:|------------:|--------|-----------:|---------:|---------:|------:|--------|
| Tavily (primary) | **ACTIVE** | True | True | 20 | 1000 | ERROR | 90.8 | 0.0 | 0.0 | 0.0 | ready |
...
| Brave Search API | **DISABLED** | False | False | 20 | 2000 | offline | 0.01 | 0.0 | 0.0 | 1.0 | enabled=false in discovery_registry.yaml |
...
- Probe: `{"probed": true, "ok": false, "status": "ERROR", "message": "connectivity_failed:HTTPError", "latency_ms": 90.8}`
