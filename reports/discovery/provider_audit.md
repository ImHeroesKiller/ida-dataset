...
|----------|--------|---------|------------|----------:|------------:|--------|-----------:|---------:|---------:|------:|--------|
| Tavily (primary) | **ACTIVE** | True | True | 20 | 1000 | ACTIVE | 2352.6 | 160.0 | 141.0 | 1.0 | ready |
...
- Probe: `{"probed": true, "ok": true, "status": "ACTIVE", "message": "http_200_results_1", "latency_ms": 2352.6, "http_status": 200, "result_count": 1}`
