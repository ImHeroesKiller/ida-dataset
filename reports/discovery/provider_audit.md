...
|----------|--------|---------|------------|----------:|------------:|--------|-----------:|---------:|---------:|------:|--------|
| Tavily (primary) | **ACTIVE** | True | True | 20 | 1000 | ERROR | 145.2 | 0.0 | 0.0 | 1.0 | ready |
...
| RSS Discovery | **ACTIVE** | True | True | 30 | 10000 | healthy | 0.0 | 10.0 | 2.0 | 1.0 | ready |
...
| SerpAPI | **DISABLED** | False | False | 10 | 100 | offline | 0.02 | 0.0 | 0.0 | 1.0 | enabled=false in discovery_registry.yaml |
...
- Probe: `{"probed": true, "ok": false, "status": "ERROR", "message": "connectivity_failed:HTTPError", "latency_ms": 145.2}`
