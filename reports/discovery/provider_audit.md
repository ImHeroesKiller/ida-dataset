...
|----------|--------|---------|------------|----------:|------------:|--------|-----------:|---------:|---------:|------:|--------|
| Tavily (primary) | **ACTIVE** | True | True | 20 | 1000 | ERROR | 225.4 | 0.0 | 0.0 | 0.0 | ready |
...
| Atom Discovery | **ACTIVE** | True | True | 30 | 10000 | healthy | 0.0 | 15.0 | 7.0 | 1.0 | ready |
| Common Crawl Index | **ACTIVE** | True | True | 5 | 500 | healthy | 0.0 | 60.0 | 30.0 | 1.0 | ready |
...
- Probe: `{"probed": true, "ok": false, "status": "ERROR", "message": "connectivity_failed:HTTPError", "latency_ms": 225.4}`
