...
|----------|--------|---------|------------|----------:|------------:|--------|-----------:|---------:|---------:|------:|--------|
| Tavily (primary) | **ACTIVE** | True | True | 20 | 1000 | ERROR | 231.6 | 0.0 | 0.0 | 1.0 | ready |
...
| Bing Web Search API | **DISABLED** | False | False | 30 | 1000 | offline | 0.01 | 0.0 | 0.0 | 1.0 | enabled=false in discovery_registry.yaml |
...
- Probe: `{"probed": true, "ok": false, "status": "ERROR", "message": "connectivity_failed:HTTPError", "latency_ms": 231.6}`
