...
| `automation/learning/state/acquisition_performance.json` | 442 | `"process_budget": 14,` |
| `automation/learning/state/diagnostics_last.json` | 633 | `"hard_limit": null,` |
