...
**Generated:** 2026-08-22T19:36:20+00:00
...
| `automation/learning/state/acquisition_performance.json` | 659 | `"process_budget": 75,` |
...
| `automation/ci/validate_repo.py` | 226 | `if path.parts[:1] == (".github",) or ".github" in path.parts:` |
