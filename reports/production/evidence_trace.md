...
- **Dataset row:** `SIG-001385` · Exploring the influence of regional economic pillars on library service equity in Indonesia (business_signal_library)
...
- **Dataset row:** `SIG-001386` · World Bank document (business_signal_library)
...
- **Dataset row:** `SIG-001387` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
...
- **Dataset row:** `SIG-001388` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
...
- **Dataset row:** `SIG-001389` · Indonesia - Library Development Project (business_signal_library)
