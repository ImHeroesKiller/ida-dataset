...
- **Dataset row:** `SIG-001220` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-544F0ED9A6C4`
...
- **Dataset row:** `SIG-001222` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-1236F090CCC8`
...
- **Dataset row:** `SIG-001223` · Development of the Siak Library and Archives Service (2004-2022) (business_signal_library)
- **Candidate:** `CAND-BC59406A3176`
...
- **Dataset row:** `SIG-001224` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-988C43EE8A86`
