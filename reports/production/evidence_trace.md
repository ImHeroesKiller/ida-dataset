...
- **Dataset row:** `SIG-001210` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-F265D26BE90B`
...
- **Dataset row:** `SIG-001212` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-D50A7FD7C37D`
...
- **Dataset row:** `SIG-001213` · Development of the Siak Library and Archives Service (2004-2022) (business_signal_library)
- **Candidate:** `CAND-9478F34581C7`
...
- **Dataset row:** `SIG-001214` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-0A575DF910FE`
