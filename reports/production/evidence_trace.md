...
- **Dataset row:** `SIG-001055` · Exploring the influence of regional economic pillars on library service equity in Indonesia (business_signal_library)
- **Candidate:** `CAND-19D4BF893B29`
...
- **Dataset row:** `SIG-001056` · World Bank document (business_signal_library)
- **Candidate:** `CAND-5310A82B5B37`
...
- **Dataset row:** `SIG-001057` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-2D19BDB5865A`
...
- **Dataset row:** `SIG-001058` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-68A0CE1C3679`
...
- **Dataset row:** `SIG-001059` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-CE894317FA03`
