...
- **Dataset row:** `SIG-001115` · Exploring the influence of regional economic pillars on library service equity in Indonesia (business_signal_library)
...
- **Dataset row:** `SIG-001116` · World Bank document (business_signal_library)
...
- **Dataset row:** `SIG-001117` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
...
- **Dataset row:** `SIG-001118` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
...
- **Dataset row:** `SIG-001119` · Indonesia - Library Development Project (business_signal_library)
