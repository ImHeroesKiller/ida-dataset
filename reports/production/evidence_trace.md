...
- **Dataset row:** `SIG-000880` · Exploring the influence of regional economic pillars on library service equity in Indonesia (business_signal_library)
- **Candidate:** `CAND-C0CBAD3ABE52`
...
- **Dataset row:** `SIG-000882` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-008602DDAB28`
...
- **Dataset row:** `SIG-000883` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-E202186D791D`
...
- **Dataset row:** `SIG-000884` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-0B3629F52836`
