...
- **Dataset row:** `SIG-001300` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
...
- **Dataset row:** `SIG-001301` · World Bank document (business_signal_library)
...
- **Dataset row:** `SIG-001302` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
...
- **Dataset row:** `SIG-001303` · Development of the Siak Library and Archives Service (2004-2022) (business_signal_library)
...
- **Dataset row:** `SIG-001304` · Indonesia - Library Development Project (business_signal_library)
