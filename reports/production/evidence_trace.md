...
- **Dataset row:** `SIG-000425` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-05B01C784938`
...
- **Dataset row:** `SIG-000427` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-7F8CC145289F`
...
- **Dataset row:** `SIG-000428` · Development of the Siak Library and Archives Service (2004-2022) (business_signal_library)
- **Candidate:** `CAND-8A6C4EC0F26F`
...
- **Dataset row:** `SIG-000429` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-9EB754886DF5`
