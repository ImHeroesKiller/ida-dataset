...
- **Dataset row:** `SIG-001605` · Exploring the influence of regional economic pillars on library service equity in Indonesia (business_signal_library)
- **Candidate:** `CAND-F63660754218`
...
- **Dataset row:** `SIG-001606` · World Bank document (business_signal_library)
- **Candidate:** `CAND-FAE53EC70D9F`
...
- **Dataset row:** `SIG-001607` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-E54F84B804EE`
...
- **Dataset row:** `SIG-001608` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-3AD9A8305968`
...
- **Dataset row:** `SIG-001609` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-95C4FE73A692`
