...
- **Dataset row:** `SIG-001070` · Exploring the influence of regional economic pillars on library service equity in Indonesia (business_signal_library)
- **Candidate:** `CAND-9F1ADC90BBB9`
...
- **Dataset row:** `SIG-001071` · World Bank document (business_signal_library)
- **Candidate:** `CAND-8DC21786DE0B`
...
- **Dataset row:** `SIG-001072` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-83F5ABFF91FA`
...
- **Dataset row:** `SIG-001073` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-7D934C4C297B`
...
- **Dataset row:** `SIG-001074` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-9343B107AE51`
