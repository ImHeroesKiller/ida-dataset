...
- **Dataset row:** `SIG-000370` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-2BD7862F1812`
...
- **Dataset row:** `SIG-000372` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-AAA89471219C`
...
- **Dataset row:** `SIG-000373` · Development of the Siak Library and Archives Service (2004-2022) (business_signal_library)
- **Candidate:** `CAND-E0AA2401D8DC`
...
- **Dataset row:** `SIG-000374` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-77B1F26BB6AE`
