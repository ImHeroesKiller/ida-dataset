...
- **Dataset row:** `SIG-001480` · Exploring the influence of regional economic pillars on library service equity in Indonesia (business_signal_library)
- **Candidate:** `CAND-AABDB9BF5F17`
...
- **Dataset row:** `SIG-001481` · World Bank document (business_signal_library)
- **Candidate:** `CAND-98AC028EE035`
...
- **Dataset row:** `SIG-001482` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-B1BBEF3285C4`
...
- **Dataset row:** `SIG-001483` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-DA3DE215CADE`
...
- **Dataset row:** `SIG-001484` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-BA4D39DC6C6F`
