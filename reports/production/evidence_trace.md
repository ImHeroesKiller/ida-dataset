...
- **Dataset row:** `SIG-001090` · Exploring the influence of regional economic pillars on library service equity in Indonesia (business_signal_library)
...
- **Dataset row:** `SIG-001092` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
...
- **Dataset row:** `SIG-001093` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
...
- **Dataset row:** `SIG-001094` · Indonesia - Library Development Project (business_signal_library)
