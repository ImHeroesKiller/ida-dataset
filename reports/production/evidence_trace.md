...
- **Dataset row:** `SIG-000670` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-01A693A9D5BF`
...
- **Dataset row:** `SIG-000672` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-50836D1CF523`
...
- **Dataset row:** `SIG-000673` · Development of the Siak Library and Archives Service (2004-2022) (business_signal_library)
- **Candidate:** `CAND-79FD77C7E9C2`
...
- **Dataset row:** `SIG-000674` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-35BBF11CBBBD`
