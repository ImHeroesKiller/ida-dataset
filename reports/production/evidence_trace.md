...
- **Dataset row:** `SIG-001110` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-407122850648`
...
- **Dataset row:** `SIG-001112` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-82F7532AEFAC`
...
- **Dataset row:** `SIG-001113` · Development of the Siak Library and Archives Service (2004-2022) (business_signal_library)
- **Candidate:** `CAND-5362ED51506C`
...
- **Dataset row:** `SIG-001114` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-9A027E7A50B6`
