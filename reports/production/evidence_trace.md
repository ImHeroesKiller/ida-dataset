...
- **Dataset row:** `SIG-001185` · Exploring the influence of regional economic pillars on library service equity in Indonesia (business_signal_library)
- **Candidate:** `CAND-6F97ED1404E6`
...
- **Dataset row:** `SIG-001186` · World Bank document (business_signal_library)
- **Candidate:** `CAND-7700314A009F`
...
- **Dataset row:** `SIG-001187` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-C0D7A55776AF`
...
- **Dataset row:** `SIG-001188` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-DD3EF0ED7605`
...
- **Dataset row:** `SIG-001189` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-6214C03A738E`
