...
- **Dataset row:** `SIG-002005` · Exploring the influence of regional economic pillars on library service equity in Indonesia (business_signal_library)
- **Candidate:** `CAND-AD7197898232`
...
- **Dataset row:** `SIG-002006` · World Bank document (business_signal_library)
- **Candidate:** `CAND-404FE3AE6B1C`
...
- **Dataset row:** `SIG-002007` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-E5B93681AE5D`
...
- **Dataset row:** `SIG-002008` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-23E2BAD1843B`
...
- **Dataset row:** `SIG-002009` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-0A4759612CCB`
