...
- **Dataset row:** `SIG-000395` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-8E57E1555839`
...
- **Dataset row:** `SIG-000396` · World Bank document (business_signal_library)
- **Candidate:** `CAND-88379B983854`
...
- **Dataset row:** `SIG-000397` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-267F0F640438`
...
- **Dataset row:** `SIG-000398` · Development of the Siak Library and Archives Service (2004-2022) (business_signal_library)
- **Candidate:** `CAND-4BCFDAB440A0`
...
- **Dataset row:** `SIG-000399` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-E28AB473F669`
