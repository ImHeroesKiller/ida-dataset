...
- **Dataset row:** `SIG-000080` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-1B872BD3F954`
...
- **Dataset row:** `SIG-000081` · World Bank document (business_signal_library)
- **Candidate:** `CAND-3E27E3F8FA68`
...
- **Dataset row:** `SIG-000082` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-B01FF3661621`
...
- **Dataset row:** `SIG-000083` · Development of the Siak Library and Archives Service (2004-2022) (business_signal_library)
- **Candidate:** `CAND-DBA61E770828`
...
- **Dataset row:** `SIG-000084` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-9FE40C8ECC48`
