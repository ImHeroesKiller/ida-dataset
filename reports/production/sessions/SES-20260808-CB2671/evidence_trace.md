...
- **Dataset row:** `SIG-001590` · Exploring the influence of regional economic pillars on library service equity in Indonesia (business_signal_library)
- **Candidate:** `CAND-A6FDD4EA3E10`
...
- **Dataset row:** `SIG-001591` · World Bank document (business_signal_library)
- **Candidate:** `CAND-00719BD18825`
...
- **Dataset row:** `SIG-001592` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-332BACE1F641`
...
- **Dataset row:** `SIG-001593` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-1A190230402A`
...
- **Dataset row:** `SIG-001594` · Development of the Siak Library and Archives Service (2004-2022) (business_signal_library)
- **Candidate:** `CAND-896A3F163EA0`
