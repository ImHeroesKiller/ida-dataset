...
- **Dataset row:** `SIG-001685` · Exploring the influence of regional economic pillars on library service equity in Indonesia (business_signal_library)
- **Candidate:** `CAND-BC43C1233A8C`
...
- **Dataset row:** `SIG-001686` · World Bank document (business_signal_library)
- **Candidate:** `CAND-714EA768C8AF`
...
- **Dataset row:** `SIG-001687` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-FE1B7B8AFA81`
...
- **Dataset row:** `SIG-001688` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-6FF092643723`
...
- **Dataset row:** `SIG-001689` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-AFB22C3F061C`
