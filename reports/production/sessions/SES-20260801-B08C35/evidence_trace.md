...
- **Dataset row:** `SIG-001230` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-BF8059258BAF`
...
- **Dataset row:** `SIG-001231` · World Bank document (business_signal_library)
- **Candidate:** `CAND-7DC7B1FF711C`
...
- **Dataset row:** `SIG-001232` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-31834BDF6ED8`
...
- **Dataset row:** `SIG-001233` · Development of the Siak Library and Archives Service (2004-2022) (business_signal_library)
- **Candidate:** `CAND-306BD1BDD079`
...
- **Dataset row:** `SIG-001234` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-B34BD716C68C`
