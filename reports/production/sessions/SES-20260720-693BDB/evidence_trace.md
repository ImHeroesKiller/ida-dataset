...
- **Dataset row:** `SIG-000560` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-72F03042AF64`
...
- **Dataset row:** `SIG-000561` · World Bank document (business_signal_library)
- **Candidate:** `CAND-A9E110DF3597`
...
- **Dataset row:** `SIG-000562` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-DCADF6F71579`
...
- **Dataset row:** `SIG-000563` · Development of the Siak Library and Archives Service (2004-2022) (business_signal_library)
- **Candidate:** `CAND-4BE602C3945C`
...
- **Dataset row:** `SIG-000564` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-51AA6CAE4A5A`
