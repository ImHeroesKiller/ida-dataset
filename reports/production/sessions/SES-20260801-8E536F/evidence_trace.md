...
- **Dataset row:** `SIG-001190` · Exploring the influence of regional economic pillars on library service equity in Indonesia (business_signal_library)
- **Candidate:** `CAND-57FC4DD9AD32`
...
- **Dataset row:** `SIG-001192` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-012D1CEC7F6D`
...
- **Dataset row:** `SIG-001193` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-F235382A9F71`
...
- **Dataset row:** `SIG-001194` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-751909187A47`
