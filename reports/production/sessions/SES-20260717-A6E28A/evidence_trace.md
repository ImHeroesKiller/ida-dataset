...
- **Dataset row:** `SIG-000405` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-E5A3B0E6E924`
...
- **Dataset row:** `SIG-000406` · World Bank document (business_signal_library)
- **Candidate:** `CAND-51BBBA2451C8`
...
- **Dataset row:** `SIG-000407` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-BAD46F2FFC45`
...
- **Dataset row:** `SIG-000408` · Development of the Siak Library and Archives Service (2004-2022) (business_signal_library)
- **Candidate:** `CAND-BAEC0C237D19`
...
- **Dataset row:** `SIG-000409` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-2579CEF9131B`
