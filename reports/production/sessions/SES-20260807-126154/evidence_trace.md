...
- **Dataset row:** `SIG-001495` · Exploring the influence of regional economic pillars on library service equity in Indonesia (business_signal_library)
- **Candidate:** `CAND-F9E7F770896E`
...
- **Dataset row:** `SIG-001496` · World Bank document (business_signal_library)
- **Candidate:** `CAND-39C060ED3946`
...
- **Dataset row:** `SIG-001497` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-3EC561ADB9A4`
...
- **Dataset row:** `SIG-001498` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-94FDCF359D24`
...
- **Dataset row:** `SIG-001499` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-8C4185F1695C`
