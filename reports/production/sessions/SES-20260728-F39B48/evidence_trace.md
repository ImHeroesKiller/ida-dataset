...
- **Dataset row:** `SIG-000990` · Exploring the influence of regional economic pillars on library service equity in Indonesia (business_signal_library)
- **Candidate:** `CAND-BB814C2D5C63`
...
- **Dataset row:** `SIG-000992` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-82DD8E520197`
...
- **Dataset row:** `SIG-000993` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-FCC38BA16DE1`
...
- **Dataset row:** `SIG-000994` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-BDEB7C09384A`
