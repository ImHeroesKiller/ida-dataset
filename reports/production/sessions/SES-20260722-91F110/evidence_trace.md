...
- **Dataset row:** `SIG-000700` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-FCE16279571C`
...
- **Dataset row:** `SIG-000702` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-43A775E687D5`
...
- **Dataset row:** `SIG-000703` · Development of the Siak Library and Archives Service (2004-2022) (business_signal_library)
- **Candidate:** `CAND-AD7FEC1E1C89`
...
- **Dataset row:** `SIG-000704` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-6ED150D509D3`
