...
- **Dataset row:** `SIG-000350` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-119F638DF0A7`
...
- **Dataset row:** `SIG-000351` · The biodiversity and ecosystem service contributions and trade-offs of forest restoration approaches (business_signal_library)
- **Candidate:** `CAND-E13B13782F7A`
...
- **Dataset row:** `SIG-000352` · World Bank document (business_signal_library)
- **Candidate:** `CAND-2868F8C0DE7B`
...
- **Dataset row:** `SIG-000353` · Development of the Siak Library and Archives Service (2004-2022) (business_signal_library)
- **Candidate:** `CAND-D71DFF3E376A`
...
- **Dataset row:** `SIG-000354` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-A30DC3F2212D`
