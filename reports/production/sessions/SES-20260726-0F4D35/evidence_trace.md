...
- **Dataset row:** `SIG-000920` · Exploring the influence of regional economic pillars on library service equity in Indonesia (business_signal_library)
- **Candidate:** `CAND-7AAFEC033B1F`
...
- **Dataset row:** `SIG-000922` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-5674784BC955`
...
- **Dataset row:** `SIG-000923` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-60293767341E`
...
- **Dataset row:** `SIG-000924` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-926B41A73525`
