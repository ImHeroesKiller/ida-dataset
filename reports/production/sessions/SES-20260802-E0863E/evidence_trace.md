...
- **Dataset row:** `SIG-001240` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-31FB27ABBC2F`
...
- **Dataset row:** `SIG-001242` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-9A6361C97A1E`
...
- **Dataset row:** `SIG-001243` · Development of the Siak Library and Archives Service (2004-2022) (business_signal_library)
- **Candidate:** `CAND-5AB4EF81E30A`
...
- **Dataset row:** `SIG-001244` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-F48E277E249E`
