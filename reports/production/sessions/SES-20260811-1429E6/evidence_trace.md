...
- **Dataset row:** `SIG-001905` · Exploring the influence of regional economic pillars on library service equity in Indonesia (business_signal_library)
- **Candidate:** `CAND-D4D5D6B0FF58`
...
- **Dataset row:** `SIG-001906` · World Bank document (business_signal_library)
- **Candidate:** `CAND-5EF1B06B3907`
...
- **Dataset row:** `SIG-001907` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-ED344A1D9A4F`
...
- **Dataset row:** `SIG-001908` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-8C1AEDF5E714`
...
- **Dataset row:** `SIG-001909` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-19E23356FE15`
