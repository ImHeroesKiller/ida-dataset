...
- **Dataset row:** `SIG-000615` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-B12181371BB8`
...
- **Dataset row:** `SIG-000617` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-FCAB21EAB39B`
...
- **Dataset row:** `SIG-000618` · Development of the Siak Library and Archives Service (2004-2022) (business_signal_library)
- **Candidate:** `CAND-F7A0FAF0B43C`
...
- **Dataset row:** `SIG-000619` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-C043FCD55052`
