...
- **Dataset row:** `SIG-001755` · Exploring the influence of regional economic pillars on library service equity in Indonesia (business_signal_library)
- **Candidate:** `CAND-6F3370071C00`
...
- **Dataset row:** `SIG-001756` · World Bank document (business_signal_library)
- **Candidate:** `CAND-9BEFCBCADDEC`
...
- **Dataset row:** `SIG-001757` · New normal and library services in Indonesia: a case study of university libraries (business_signal_library)
- **Candidate:** `CAND-2135647006D0`
...
- **Dataset row:** `SIG-001758` · The Influence of Service Quality on Library Users at Padang State Polytechnic (business_signal_library)
- **Candidate:** `CAND-5DB9B017C53B`
...
- **Dataset row:** `SIG-001759` · Indonesia - Library Development Project (business_signal_library)
- **Candidate:** `CAND-142B89C6238A`
