...
**Session:** `SES-20260726-CED7A6` · **Mission:** corporate governance — service knowledge for Corporate Governance — continuous knowledge manufacturing for service_library across enterprise function Corporate Governance (function_gap=58.4; not BD-only); dataset_gap=112.922; mode=BOOTSTRAP

| Connector | Status | HTTP | Elapsed (ms) | Discovered | Downloaded | Skipped | Rejected | Retries | Error |
|-----------|--------|------|-------------:|-----------:|-----------:|--------:|---------:|--------:|-------|
| Asian Development Bank | no_updates | 200 | 97.3 | 0 | 0 | 0 | 0 | 0 | — |
| BPS Indonesia | no_updates | 200 | 151.2 | 0 | 11 | 0 | 0 | 0 | — |
| OECD | no_updates | 200 | 244.5 | 0 | 0 | 0 | 0 | 0 | — |
| Crossref | ok | 200 | 437.5 | 10 | 0 | 0 | 0 | 0 | — |
| World Bank | ok | 200 | 572.3 | 11 | 0 | 0 | 0 | 0 | — |
| OpenAlex | no_updates | 200 | 3375.2 | 0 | 0 | 0 | 0 | 0 | — |
| Kemenperin | no_updates | 200 | 94145.8 | 0 | 0 | 0 | 0 | 0 | — |
...
- last_successful_sync: 2026-07-26T11:33:27+00:00
