...
Gap floor per cell: **2** (progress signal, not a stop).
...
| Corporate Strategy | `buyer_persona_library` | 0 | 2 | 59.2 |
| Corporate Strategy | `case_study_library` | 0 | 2 | 59.2 |
| Corporate Strategy | `regulation_library` | 0 | 2 | 59.2 |
| Corporate Strategy | `risk_library` | 0 | 2 | 59.2 |
| Corporate Strategy | `trend_library` | 0 | 2 | 59.2 |
| Risk Management | `buyer_persona_library` | 0 | 2 | 59.2 |
...
| Risk Management | `solution_library` | 0 | 2 | 59.2 |
| Risk Management | `trend_library` | 0 | 2 | 59.2 |
...
| Human Resources | `case_study_library` | 0 | 2 | 59.0 |
